<template>
    <div>
    <h1>Processed Service Records</h1>
    <TaskItem
...
import { getProcessedServiceRecords, fetchProcessedTotalRecords } from '@/api/service';
  export default {
  components: {
    TaskItem
  },
  ...
  methods: {
    fetchRecords() {
      getProcessedServiceRecords(this.page, this.limit)
        .then(response => {
